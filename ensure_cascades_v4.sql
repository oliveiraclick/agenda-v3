...
-- Safe Deletion Cascades V4 (ULTIMATE FIX)
-- Ensures that when an establishment is deleted, everything related to it is also deleted automatically.
-- This version includes existing dependencies + Level 2 Cacsades + EXPENSES table.
...
-- 10. Expenses (NEW - The likely culprit if they use financial module)
ALTER TABLE expenses
DROP CONSTRAINT IF EXISTS expenses_establishment_id_fkey,
