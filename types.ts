...
export type CustomerView = 'onboarding' | 'login' | 'signup' | 'forgot_password' | 'auth_register' | 'discovery' | 'portal' | 'booking' | 'loyalty' | 'history' | 'favorites' | 'profile' | 'auth_reset' | 'auth_feedback';
...
export interface Appointment {
  ...
  professional: string;
  price: number;
  status: 'confirmed' | 'pending' | 'blocked' | 'free' | 'in_progress' | 'completed';
  type?: 'lunch' | 'break';
}
